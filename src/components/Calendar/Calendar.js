		...
		<div className="container">
			<ul className="calendar-list">
				<li className="calendar-item">
					<article className="launches">
						<div className="launches-image">
							<img src="https://images2.imgbox.com/3c/0e/T8iJcSN3_o.png" alt="cosmogaeret" />
						...
						<div className="launches-content">
							...
							<a href="./details.html" className="button launches-details">Weiter lesen</a>
						</div>
					</article>
				</li>
				...
				<li className="calendar-item">
					<article className="launches">
						<div className="launches-image">
							<img src="https://images2.imgbox.com/3d/86/cnu0pan8_o.png" alt="cosmogaeret" />
						</div>
						<div className="launches-content">
							<h2 className="launches-title">
				...
				<li className="calendar-item">
					<article className="launches">
						<div className="launches-image">
							<img src="https://images2.imgbox.com/e9/c9/T8CfiSYb_o.png" alt="cosmogaeret" />
						</div>
						<div className="launches-content">
							<h2 className="launches-title">
